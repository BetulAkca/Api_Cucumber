...
public class DataForApi {
    public static Map<String,Object> registerUserBody(String email,
    ...
    */
    public static Map<String,Object> saveProfileBody(String company,
     ...
     */
    public static Map<String,Object> addExperienceBody(String title,String company,
